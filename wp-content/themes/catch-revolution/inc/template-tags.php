 ...
 */
function catch_revolution_archives_cat_count_span($links) {
	$links = str_replace('</a> (', '</a> <span>(', $links);
	$links = str_replace(')', ')</span>', $links);
	return $links;
}
add_filter('wp_list_categories', 'catch_revolution_archives_cat_count_span');

/**
 * Used to wrap post count in Archives widget with a span tag
 */
function catch_revolution_archives_count_span($links) {
	$links = str_replace('</a>&nbsp;(', '</a> <span>(', $links);
	$links = str_replace(')', ')</span>', $links);
	return $links;
}
add_filter('get_archives_link', 'catch_revolution_archives_count_span');
