...
<div id="toplogo" class="toplogo <?php echo esc_attr( $exs_font_size . ' ' . $exs_header_toplogo_bg . ' ' . $exs_header_top_tall ); ?>">
	<div class="container<?php echo esc_attr( $exs_fluid ); ?> container-md-flex">
		...
		if ( 'button' === $exs_search ) :
			?>
		<div class="search-social-wrap d-flex <?php echo esc_attr( $exs_social_hidden_class ); ?>">
		<?php else : ?>
		<div class="search-social-wrap flex-column <?php echo esc_attr( $exs_social_hidden_class ); ?>">
			<?php
		endif; //button
		if ( ! empty( $exs_search ) ) :
